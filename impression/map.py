...
def creating_map():
    ...
    map = folium.Map(location=[56.8324, -299.4488], width=600, height=400, popup='more info', zoom_start=5)
    return map
...
def marking_location(coordinate):
    ...
    folium.Marker(coordinate, tooltip='click here for more', popup=coordinate, icon=folium.Icon(color='red')).add_to(map)
    return map
